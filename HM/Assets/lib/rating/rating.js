!function (t) {
    ...
    function r(a) {
        ...
        return t[a].call(s.exports, s, s.exports, r),
            s.l = !0,
            s.exports
    }
    r.m = t,
        ...
        rating: function (t = {}) {
            return this.each((function () {
                $(this).attr("rating") && $(this).empty(),
                    ...
                    this.readonly || ($(this).off("mousemove").on("mousemove", (function (e) {
                        ...
                        if (this.getStars().index(e.target) >= 0)
                            if (a) {
                                ...
                                for (let e = 0; e < this.getStars().length; e++)
                                    e + .5 < s ? $(this.getStars()[e]).attr("class", t.filledStar ? t.filledStar : r.filledStar) : e < s && $(this.getStars()[e]).attr("class", t.halfStar ? t.halfStar : r.halfStar)
                            } else {
                                $(this).find("i").attr("class", t.emptyStar ? t.emptyStar : r.emptyStar);
                                let a = this.getStars().index(e.target) + 1;
                                for (let e = 0; e < this.getStars().length; e++)
                                    e < a && $(this.getStars()[e]).attr("class", t.filledStar ? t.filledStar : r.filledStar)
                            }
                    }
                    )),
                ...
                if (this.printStars = function () {
                    if (t.half ? t.half : r.half) {
                        ...
                        for (let e = 0; e < this.stars; e++)
                            e < this.stars - .5 ? $(this.getStars()[e]).attr("class", t.filledStar ? t.filledStar : r.filledStar) : $(this.getStars()[e]).attr("class", t.halfStar ? t.halfStar : r.halfStar)
                    } else {
                        $(this).find("i").attr("class", t.emptyStar ? t.emptyStar : r.emptyStar);
                        for (let e = 0; e < this.stars; e++)
                            $(this.getStars()[e]).attr("class", t.filledStar ? t.filledStar : r.filledStar)
                    }
                }
                    ,
                    this.stars > 0) {
